...
import { MetasProductMultired } from '../types/interfaces'
import { ReduceMultired } from '../utils/funtions';
...
export const getMetasController = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const test = metas.reduce(ReduceMultired, initialObjectMultired);
