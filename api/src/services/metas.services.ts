...
const PRODUCTOS_JAMUNDI = ['CHANCE', 'CHOLADITO', 'PAGATODO_JAMUNDI', 'GANE5', 'PATA_MILLONARIA', 'DOBLECHANCE', 'CHANCE_MILLONARIO', 'ASTRO', 'LOTERIA_FISICA', 'LOTERIA_VIRTUAL', 'BETPLAY', 'GIROS', 'SOAT', 'PROMO1', 'PROMO2', 'RECAUDOS', 'RECARGAS', 'SUCURSAL','PROMEDIO_DIARIO_CHANCE','PROMEDIO_DIARIO_CHOLADITO','PROMEDIO_DIARIO_PGTJAMUNDI','PROMEDIO_DIARIO_GANE5','PROMEDIO_DIARIO_PATAMI','PROMEDIO_DIARIO_DOBLECHANCE','PROMEDIO_DIARIO_CHMILL','PROMEDIO_DIARIO_ASTRO','PROMEDIO_DIARIO_LF','PROMEDIO_DIARIO_LV','PROMEDIO_DIARIO_BETPLAY','PROMEDIO_DIARIO_GIROS','PROMEDIO_DIARIO_SOAT','META_PROMO2','PROMEDIO_DIARIO_RECAUDOS','PROMEDIO_DIARIO_RECARGAS',]

const PRODUCTOS_YUMBO = ['CHANCE', 'PAGAMAS', 'PAGATODO', 'GANE5', 'PATA_MILLONARIA', 'DOBLECHANCE', 'CHANCE_MILLONARIO', 'ASTRO', 'LOTERIA_FISICA', 'LOTERIA_VIRTUAL', 'BETPLAY', 'GIROS', 'SOAT', 'PROMO1', 'PROMO2', 'RECAUDOS', 'RECARGAS', 'SUCURSAL',   'PROMEDIO_DIARIO_CHANCE','PROMEDIO_DIARIO_PAGAMAS','PROMEDIO_DIARIO_PAGATODO','PROMEDIO_DIARIO_GANE5','PROMEDIO_DIARIO_PATAMI','PROMEDIO_DIARIO_DOBLECHANCE','PROMEDIO_DIARIO_CHMILL','PROMEDIO_DIARIO_ASTRO','PROMEDIO_DIARIO_LF','PROMEDIO_DIARIO_LV','PROMEDIO_DIARIO_BETPLAY','PROMEDIO_DIARIO_GIROS','PROMEDIO_DIARIO_SOAT','META_PROMO2','PROMEDIO_DIARIO_RECAUDOS','PROMEDIO_DIARIO_RECARGAS',]
